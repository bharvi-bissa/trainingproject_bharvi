...
<%@page import="com.techaspect.dao.VendorDao"%>
<%
...
<body>
	...
	<div class="container pt-4 pb-4" style="min-height:800px;">
		<%
			if((String)session.getAttribute("error_insert_product") !=null){
				%>
				<p class="alert alert-danger"><%= (String)session.getAttribute("error_insert_product") %></p>
			<% } session.removeAttribute("error_insert_product"); %>
		<h1 class="mb-4" style="font-weight:lighter">Add new product.</h1>
		<div class="row">
			<div class="col-md-8">
				<form action="VendorAddProduct" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<TextArea type="description" class="form-control" name="product_description"></TextArea>
					</div>
					<div class="form-group">
					    <label for="exampleFormControlFile1">Product Image 1</label>
					    <input type="file" class="form-control-file" id="exampleFormControlFile1" name="product_image1">
				  	</div>
					<div class="form-group">
					    <label for="exampleFormControlFile1">Product Image 2</label>
					    <input type="file" class="form-control-file" id="exampleFormControlFile1" name="product_image2">
				  	</div>
				  	<div class="form-group">
					    <label for="exampleFormControlFile1">Product Image 3</label>
					    <input type="file" class="form-control-file" id="exampleFormControlFile1" name="product_image3">
				  	</div>
				  	<div class="form-group">
					    <label for="exampleFormControlFile1">Product Image 4</label>
					    <input type="file" class="form-control-file" id="exampleFormControlFile1" name="product_image4">
				  	</div>
				  	<div class="form-group">
					    <label for="exampleFormControlFile1">Product Image 5</label>
					    <input type="file" class="form-control-file" id="exampleFormControlFile1" name="product_image5">
				  	</div>
				  	<br>
				  	<div class="form-group">
